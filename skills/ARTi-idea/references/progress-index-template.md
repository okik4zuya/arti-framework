...
> complete (handoff written), writing started, submitted. Not once per stage: a dashboard that
> is rewritten five times during idea development costs more upkeep than the overview is worth,
> and nobody reads it between stages anyway.
